...
/** Curated subset for public marketing pages — the more visually/conceptually distinctive tools. */
export const publicShowcaseToolIds = [
  'macro-engine',
  'trade-radar',
  'cvar-optimizer',
  'equity-positioning',
...
export const publicShowcaseTools = toolCatalog.filter((tool) =>
  publicShowcaseToolIds.includes(tool.id)
);
