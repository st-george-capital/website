...
export const VARIABLES: VariableDef[] = [
  ...
  },
  {
    ...
    kind: 'structural',
    useChange: false,
    why: 'Power availability proxy for AI infrastructure, data centers, industrial automation, and grid depth.',
    weight: 1.5,
  },
  {
    ...
    kind: 'structural',
    useChange: false,
    why: 'Reliance on imported energy raises input-cost vulnerability and reduces strategic autonomy.',
    weight: 1.5,
  },
  {
  ...
  },
  {
    ...
    useChange: true,
    momentumMode: 'pct_change',
    why: 'Creditor-vs-debtor pressure proxy: high and rising external debt increases funding vulnerability.',
    weight: 2,
  },
  {
    ...
    label: 'Short-Term Debt / Reserves',
    unit: '% reserves',
    direction: 'down_good',
    kind: 'cyclical',
    useChange: true,
    momentumMode: 'pct_change',
    why: 'Near-term external refinancing pressure relative to reserve buffers.',
    weight: 1.5,
  },
  {
    ...
    useChange: true,
    momentumMode: 'pct_change',
    why: 'Debt service crowding-out signal — rising interest share reduces fiscal flexibility.',
    weight: 2,
  },
  {
    id: 'gold_reserve_share',
    pillar: 'macro_sustainability',
    code: '__GOLD_RESERVE_SHARE',
    ...
    useChange: true,
    momentumMode: 'pp_delta',
    why: 'Reserve diversification proxy for resilience when fiat/debt confidence deteriorates.',
    weight: 1,
  },
  {
    id: 'military_capex_burden',
    pillar: 'macro_sustainability',
    code: '__MILITARY_CAPEX_RATIO',
    label: 'Military / Capital Formation',
    unit: 'ratio',
    direction: 'down_good',
    kind: 'structural',
    useChange: false,
    why: 'Geopolitical overextension proxy: military spending relative to domestic capital investment.',
    weight: 1,
  },
  {
    id: 'unemployment',
  ...
  },
  {
    ...
    kind: 'structural',
    useChange: false,
    why: 'Financial depth proxy — credit intermediation to productive private-sector borrowers.',
    weight: 1.5,
  },
];
