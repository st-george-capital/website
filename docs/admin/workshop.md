...
Members can create projects from a blank form or one of six project starters. A project contains a research question, Markdown plan, tags, stage, repository, resource links, selected collaborators, milestones and a dated research log. Starters are proposals, with no fabricated results or assignments.
...
The quant-course seed adds four courses and sixteen lessons only when the course slug is missing. It preserves existing courses and author edits. These additions are published member courses, not example project activity.
