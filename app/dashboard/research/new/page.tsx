...
Describe revenue streams, pricing, cost structure...
...
This section will be auto-populated when you load a DCF model above. You can also manually edit/add content here.
              ...
              <CardContent className="space-y-6">
                <div>
                  ...
                  <textarea
                    ...
                    rows={12}
                    className="w-full px-3 py-2 border rounded-md font-mono text-sm"
                    placeholder="Use ## Section and ### Subsection for structure.&#10;&#10;## Bull Case Thesis&#10;Key drivers that could push the stock higher..."
                  />
                </div>
                <div>
          ...
          {activeSection === 'justification' && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>Explain the rationale behind your bull and bear scenarios.</CardDescription>
              </CardHeader>
              <CardContent>
                <textarea
                  ...
                  rows={14}
                  className="w-full px-3 py-2 border rounded-md font-mono text-sm"
                  placeholder="Optional: Why these bull/bear cases? Key assumptions..."
                />
              </CardContent>
            </Card>
          )}
