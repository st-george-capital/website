  ...
  useEffect(() => {
    const loadReport = async () => {
      try {
        ...
        setSentimentSnapshot((report as any).sentimentSnapshot || null);
        setSentimentKeyword((report as any).sentimentSnapshot?.entity?.keyword || '');
        setSentimentHorizon(String((report as any).sentimentSnapshot?.horizonDays || 7));
