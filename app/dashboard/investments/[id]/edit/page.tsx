    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({
          ...
          priceAtEntry: investment.priceAtEntry?.toString() || '',
          initialTarget: investment.initialTarget?.toString() || '',
          currentTarget: investment.currentTarget?.toString() || '',
          exitPrice: investment.exitPrice?.toString() || '',
          active: investment.active,
          publishDate: investment.publishDate ? investment.publishDate.split('T')[0] : '',
          tags: investment.tags,
          coverImage: investment.coverImage || '',
          published: investment.published,
        });
      } else {
      ...
      alert('Failed to load investment');
    } finally {
    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">Loading investment...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Update investment thesis or market outlook</p>
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center space-x-2">
              <input
                ...
                onChange={(e) => setFormData(prev => ({ ...prev, published: (e.target as HTMLInputElement).checked }))}
                className="rounded"
              />
