...
- [x] **ALLC-01**: Daily scoring cron applies current regime's factor weights to latest features and produces ranked overweight/underweight signals for all countries and sectors
